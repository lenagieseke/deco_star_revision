...
% % --------------------------------------------------------------------------------
%     \taburulecolor{middleGray}\hline
%     \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsec:analysis_distribution_and_repetition]{\textit{\uppercase{Distribution and Repetition}}}}  \\
%     \taburulecolor{middleGray}\hline

%     % Stochastic Pattern
%     % --------------------------------------------------------------------------------
%     \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsubsec:analysis_distribution_and_repetition_stochastic]{\textit{Stochastic}}} \\
...
%     % --------------------------------------------------------------------------------
%     \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsubsec:analysis_distribution_and_repetition_regular]{\textit{Regular to Near-Regular Patterns}}} \\
...
%     % --------------------------------------------------------------------------------
%     \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsubsec:analysis_rulebased_and_designspecific]{\textit{Rule- and Design-Specific Patterns}}} \\
...
%     % --------------------------------------------------------------------------------
%     \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsubsec:analysis_element_arrangements]{\textit{Element Arrangements}}} \\
...
% % --------------------------------------------------------------------------------
% \taburulecolor{middleGray}\hline
% \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsec:analysis_frames_and_hierarchies]{\textit{\uppercase{Frames and Hierarchies}}}} \\
% \taburulecolor{middleGray}\hline
...
% % --------------------------------------------------------------------------------
% \taburulecolor{middleGray}\hline
% \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsec:analysis_curves]{\textit{\uppercase{Curves and Brushing}}}} \\
% \taburulecolor{middleGray}\hline
...
% % --------------------------------------------------------------------------------
% \taburulecolor{middleGray}\hline
% \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsec:analysis_connections_branches_and_directionality]{\textit{\uppercase{Connections, Branches and Directionality}}}} \\
% \taburulecolor{middleGray}\hline
...
% % --------------------------------------------------------------------------------
% \taburulecolor{middleGray}\hline
% \multicolumn{18}{|[1pt middleGray]l|[1pt middleGray]}{\hyperref[subsubsec:analysis_single_accents]{\textit{\uppercase{Single Accents}}}} \\
% \taburulecolor{middleGray}\hline
...
%     } %\resizebox
    ...
    \includegraphics[width=0.85\textwidth]{tables/table_all.png}
    \caption[Control mechanisms in the state of the art]{Recent techniques, sorted by design areas and visual features. The specific control mechanisms each work offers is marked. *Note that \citeauthor*{mech_2012_tdf}~\cite{mech_2012_tdf} present a procedural modeling engine, which in principle can be programmed to include almost any control type.\label{table:analysis}
    % \mfcomment{This table is one of the STAR's key contributions, as it provides a structured map to the techniques we discuss. It is also a map for the STAR itself: would we want to link the labels such as DISTRIBUTION AND REPETITION / STOCHASTIC/ REGULAR etc. to the respective (sub)sections of the report? In that case, we could also move it up to the beginning of chapter 7. }
    }
\end{table*}
