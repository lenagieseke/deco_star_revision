...
\caption[Prevalence of control mechanisms]{Prevalence of control mechanisms in the literature: In total, 50 publications are included (the discussed state of the art in~\Cref{sec:analysis}). Please note that the total for each step (how, what, where, when) can exceed the total of that category because the category can be implemented in multiple ways.\label{table:taxo_controlmechanism}}
\end{table}
