...
\noindent\textbf{How (User Interaction)} is a control executed or an input given by an artist? How \revremove{}{far}\rev{}{detached} is it from the visual result on the canvas? 
