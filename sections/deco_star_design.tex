...
\begin{figure*}
    \centering
        ...
        \caption{Pattern, showcasing the design features 1. Distribution and Repetition, 2.Frames and Hierarchies, 3. Curves, Lines and Brushing, 4. Connections, Branches and Directionality, and 5. Single Accents. Examples results from left to right:~\cite{santoni_2016_ggp} (Figure 10) \color{orange}{Status rights: ACM requested},\color{black}~\cite{lu_2014_dds} (Figure 19) \color{orange}{Status rights: ACM requested},\color{black}~\cite{jacobs_2018_dbe} (Figure 1) \color{orange}{Status rights: ACM requested},\color{black}~\cite{guo_2020_ipm} (Figure 1) \color{orange}{Status rights: ACM requested},\color{black}~\cite{saputra_2017_ffo} (Figure 1). \color{red}{Status rights: not started},\color{black}~\cite{gieseke_2017_ooo} (Figure 7) \color{orange}{Status rights: ACM requested}.}
\end{figure*}
