...
Next to directions discussed in ~\Cref{sec:discussion_creative_means}, we would like to highlight directions that we haven't mentioned yet but which have great potential in regard to creative control mechanisms.
