...
% TODO: Outlook closely related to the discussed work

% review: ...for example, it is better to point out which new algorithms have the potential to further improve creative pattern design and generation, or which complex patterns themselves can stimulate and give birth to novel  algorithm or  technology).
%


Next to directions discussed in~\Cref{sec:discussion_creative_means}, we would like to highlight directions that we have not mentioned yet but which have great potential in regard to creative control mechanisms.
