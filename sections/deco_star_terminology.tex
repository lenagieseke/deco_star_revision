...
\rev{Condensing}{A \textbf{Parameterized} system offers separately controllable characteristics. In our use of the term, it does not necessarily imply a procedural pattern representation, but could also \eg apply to a data-driven one.}
