...
\textbf{Expressiveness} refers to the size, the variability and the openness of a design space as discussed in detail  in~\Cref{sec:creativ_means}. Expressiveness is commonly used in the context of creative controls, but often without a clear understanding of its meaning.
...
\rev{Condensing}{\textbf{Parameterized} refers to offering separately controllable characteristics. It can be used with procedural pattern representations, or data-driven approaches.}
