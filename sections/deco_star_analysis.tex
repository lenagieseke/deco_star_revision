...
\rev{Better Explanation of Structure}{The design feature of \textit{Single Accents} breaks with the underlying principle of procedural generation, which is to repeat certain rules and with that visual features. This overall principle is demonstrated in~\Cref{fig:guerrero_2016_pep_design}
