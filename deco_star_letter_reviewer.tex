...
thank you for your thorough and insightful feedback. With this minor revision, we hope to address the main concerns raised. In summary, you addressed the following issues:
...
% \mfcomment{… I also concur with Bedrich: we should only keep the review paragraphs we respond to.}
