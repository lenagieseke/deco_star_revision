...
The changes we made in this submission to address the above issues are colored in green. The superscript comments indicate the type of change. Furthermore, we summarize our revisions in the following section.}
...
\rev{Comment}{We added some visual examples in the Section 8, which communicate control mechanisms further.}
...
\rev{Comment}{We added an abstracted comparison of timings in Table 2. The table gives a rough overview of the preformances and also lists the publications years. This hopefully helps for a correct interpretation of the results.}
...
\rev{Comments}{We added figures for both, design features as well as interaction mechanisms.}
...
\rev{Comment}{We made a thorough pass through Section 7, condensing details to higher level descriptions. Please see the revision comments in the text. Also, ee added figures for both, design features as well as interaction mechanisms.}
...
\rev{Comment}{
    Brush-based or region-guided texture synthesis approaches are indeed closely related to the topic of the propsed STAR. We see this approach represented in our section about brush-based element texture synthesis and the included recent references of 
...
\rev{Comment}{Yes, we agree that our explanation is not clear in the submission. We changed the text to better communicate the different categories.}
